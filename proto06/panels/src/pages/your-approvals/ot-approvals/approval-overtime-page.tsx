...
export default function ApprovalOvertimePage() {
  ...
  const { OVERTIMEViewFilterApprover, OVERTIMEViewFilterEmployeeAndOVERTIME } = useSelector((state: RootState) => state.procedurals);
  ...
  return (
    <Fragment>
      ...
      <div style={{ height: `${printing? `${printableArea()}px` : '660px'}`, width: '100%' }} id="printable-area">
        ...
        />
        {/* <GeneratePDFButton data={OVERTIMEViewData} columns={ApprovalOVERTIMEPageColumns} /> */}
      </div>
    </Fragment>
  );
}
