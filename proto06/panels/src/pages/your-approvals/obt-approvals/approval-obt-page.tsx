...
export default function ApprovalOBTPage() {
  ...
  const { OBTViewFilterApprover, OBTViewFilterEmployeeAndOBT } = useSelector((state: RootState) => state.procedurals);
  ...
  return (
    <Fragment>
      ...
      <div style={{ height: `${printing? `${printableArea()}px` : '660px'}`, width: '100%' }} id="printable-area">
        ...
        />
        {/* <GeneratePDFButton data={OBTViewData} columns={ApprovalOBTPageColumns} /> */}
      </div>
    </Fragment>
  );
}
