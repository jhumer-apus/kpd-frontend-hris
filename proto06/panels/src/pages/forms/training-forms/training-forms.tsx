  ...
  const trainingFormsData = [
    ...
    ...(userState?.user?.role !== INTERNAL_USER_ROLE.Employee ) ? [
        ...
        },
        {
          ...
          custom: IconColor,
          link: `${APILink.replace('/api/v1/', '')}/media/file/Training_Attendance_Record.pdf`,
          fileDownload: true,
        ...
        },
        {
          ...
          custom: IconColor,
          link: `${APILink.replace('/api/v1/', '')}/media/file/F-HRD-03.10_Training_Evaluation_Form_rev.04.pdf`,
          fileDownload: true,
