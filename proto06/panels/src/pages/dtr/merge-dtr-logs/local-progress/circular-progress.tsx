...
function CircularProgressWithLabel(
  ...
  return (
    ...
    <span style={{textAlign: 'center', justifyContent: 'center', display: 'flex', flexDirection: 'column', padding: '10px', opacity: props.value=== 100 ? 1 : 0, transition: 'opacity 500ms ease'}}>Merge done!</span>
    </>
