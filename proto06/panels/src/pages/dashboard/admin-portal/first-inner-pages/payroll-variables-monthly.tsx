...
import { payrollVariablesMonthlyData } from "@/data/pages-data/dashboard-data/admin-portal-data";

export interface DivAnimate {
  [key: string]: boolean
}

export function PayrollVariablesMonthly() {
  ...
  return (
    <div className="mt-12" style={{height: '90vh'}}>
      <div className="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-3">
        {payrollVariablesMonthlyData.map(({ icon, title, footer, value, ...rest }, index) => (
          <div style={{
...
export default PayrollVariablesMonthly;
