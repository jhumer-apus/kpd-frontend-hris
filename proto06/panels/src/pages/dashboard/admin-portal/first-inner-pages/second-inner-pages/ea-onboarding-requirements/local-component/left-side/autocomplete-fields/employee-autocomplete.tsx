...
interface EmployeeAutoCompleteInterface{
    createONBOARDINGREQUIREMENTS: ONBOARDINGREQUIREMENTSCreateInterface;
    setCreateONBOARDINGREQUIREMENTS: Dispatch<SetStateAction<ONBOARDINGREQUIREMENTSCreateInterface>>;
}


export default function EmployeeAutoComplete(props: EmployeeAutoCompleteInterface) {
    const {setCreateONBOARDINGREQUIREMENTS, createONBOARDINGREQUIREMENTS} = props;
