...
function EAONBOARDINGREQUIREMENTSCreate(props: CreateONBOARDINGREQUIREMENTSModalInterface) {
    ...
    return (
        <React.Fragment>
            <Typography style={{border: '2px solid rgb(25, 118, 210)', width: '100%', textAlign: 'center', padding: '6px', background: 'rgb(245,247,248)', boxShadow: '4px 4px 10px rgb(200, 200, 222)'}} variant='plain' level="h6">Create and add an "Onboaring Requirement" checklist</Typography>
            <Typography className="italic p-8 flex justify-center text-center items-center" >Newly added requirements will reflect to the current "pending" and future requirements only</Typography>
