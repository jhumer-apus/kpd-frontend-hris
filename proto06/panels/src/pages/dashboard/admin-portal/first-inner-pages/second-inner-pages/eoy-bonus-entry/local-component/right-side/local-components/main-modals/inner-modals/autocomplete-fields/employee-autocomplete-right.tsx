...
interface EmployeeAutoCompleteInterface{
    createBONUSENTRY: BONUSENTRYViewInterface;
    setCreateBONUSENTRY: Dispatch<SetStateAction<BONUSENTRYViewInterface>>;
}
...
export default function EmployeeAutoCompleteRight(props: EmployeeAutoCompleteInterface) {
    ...
    const defaultOption = options?.find((option) => option.emp_no === createBONUSENTRY.emp_no)
