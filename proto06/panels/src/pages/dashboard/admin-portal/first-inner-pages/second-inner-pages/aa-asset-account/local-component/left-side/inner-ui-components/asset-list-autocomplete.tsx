...
export default function AssetListAutoComplete(props: AssetListAutoCompleteInterface) {
    const {setCreateASSETACCOUNT, createASSETACCOUNT} = props;
    ...
    const handleInputChange = (event: React.SyntheticEvent<Element, Event>, newInputValue: string, reason: AutocompleteInputChangeReason) => {
        ...
        // window.alert('No Matched AssetList in the list is found. Create an asset entry first')
        }
    };
