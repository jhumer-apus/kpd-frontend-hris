...
import PAGIBIGModalComponent from './inner-modals/pagibig-modal-component';


interface SinglePAGIBIGInterface {
    singlePAGIBIGOpenModal: boolean; 
...
export default function ViewPAGIBIGSingleModal(props: SinglePAGIBIGInterface) {
    const {singlePAGIBIGOpenModal, setSinglePAGIBIGOpenModal, setSinglePAGIBIGDetailsData, singlePAGIBIGDetailsData} = props;
