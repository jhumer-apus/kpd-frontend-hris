...
export default function ViewPerfectAttendance() {
    ...
    //USE EFFECTS
    useEffect(() => {
        fetchPerfectAttendanceRecords()
    }, [])


    //API CALLS
    const fetchPerfectAttendanceRecords = async() => {
        ...
        <Fragment>
            <div className="my-10">
                ...
                <ExportToCsvButton 
                    ...
                    defaultName={`Employee Perfect Attendance ${dayjs().month(month as number - 1).format('MMMM')} ${year}`}
                />
                ...
                <div className="md:flex md:space-x-4 md:items-center">
                    ...
                    <Button 
                        ...
                        size="lg"
                        color='indigo'
                        onClick={() => fetchPerfectAttendanceRecords()}
                        disabled={isLoading}
                    >
                        View
                    </Button>
