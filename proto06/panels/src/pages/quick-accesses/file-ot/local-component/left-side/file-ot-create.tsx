...
function QuickAccessOVERTIMECreate(props: CreateOVERTIMEModalInterface) {
    ...
    return (
        <React.Fragment>
            {/* <TextField style={{width: '100%', borderTop: '2px solid rgb(25, 118, 210)', position: 'relative',marginTop: '0px'}} variant="filled" focused InputProps={{style: {display: 'flex', justifyContent: 'center', paddingBottom: '10px'}}} value="Create OVERTIME Individual Data"></TextField> */}
