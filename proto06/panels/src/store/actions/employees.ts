...
export const getEmployeesListFailureCleanup = createAction("GET_EMPLOYEES_LIST_FAILURE_CLEANUP");
...
export const getSpecificEmployeeInfoFailureCleanup = createAction<string>("GET_SPECIFIC_EMPLOYEE_INFO_FAILURE_CLEANUP");
