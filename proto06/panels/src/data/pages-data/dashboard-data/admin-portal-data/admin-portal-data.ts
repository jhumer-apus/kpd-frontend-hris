...
export const AssetAndAnnouncementData = [
  ...
  },
  {
    ...
    custom: "linear-gradient(22deg, rgba(9,9,121,1) 15%, rgba(70,191,4,1) 47%, rgba(2,0,36,1) 100%, rgba(0,212,255,1) 100%)",
    link: '/home/Dashboards/Admin-Dashboard/Assets-And-Announcement/Asset-Account',
    customTop: 15,
    customLeft: 38,
  },
  {
...
export const EmployeeAndApplicantsData = [
  ...
  },
  {
    ...
    custom: "linear-gradient(22deg, rgba(9,9,121,1) 15%, rgba(191,4,14,1) 47%, rgba(2,0,36,1) 100%, rgba(0,212,255,1) 100%)",
    link: '/home/Dashboards/Admin-Dashboard/Employee-And-Applicants/Initialize-Onboarding',
    customTop: 15,
    customLeft: 38,
  },
  {
    ...
    custom: "linear-gradient(22deg, rgba(9,9,121,1) 15%, rgba(191,4,14,1) 47%, rgba(2,0,36,1) 100%, rgba(0,212,255,1) 100%)",
    // custom: "linear-gradient(235deg, rgba(132,25,142,1) 4%, rgba(52,9,121,0.8379726890756303) 23%, rgba(19,151,161,1) 55%)",
    link: '/home/Dashboards/Admin-Dashboard/Employee-And-Applicants/Initialize-Offboarding',
    customTop: 15,
    customLeft: 38,
  },
  {
  ...
  },
  {
    ...
    custom: "linear-gradient(22deg, rgba(9,9,121,1) 15%, rgba(191,4,14,1) 47%, rgba(2,0,36,1) 100%, rgba(0,212,255,1) 100%)",
    link: '/home/Dashboards/Admin-Dashboard/Employee-And-Applicants/Core-Competencies',
    customTop: 15,
    customLeft: 38,
  },
  {
    ...
    custom: "linear-gradient(22deg, rgba(9,9,121,1) 15%, rgba(191,4,14,1) 47%, rgba(2,0,36,1) 100%, rgba(0,212,255,1) 100%)",
    link: '/home/Dashboards/Admin-Dashboard/Employee-And-Applicants/Onboarding-Requirement',
    customTop: 15,
    customLeft: 38,
  },
  {
    ...
    custom: "linear-gradient(22deg, rgba(9,9,121,1) 15%, rgba(191,4,14,1) 47%, rgba(2,0,36,1) 100%, rgba(0,212,255,1) 100%)",
    // custom: "linear-gradient(235deg, rgba(132,25,142,1) 4%, rgba(52,9,121,0.8379726890756303) 23%, rgba(19,151,161,1) 55%)",
    link: '/home/Dashboards/Admin-Dashboard/Employee-And-Applicants/Offboarding-Requirement',
    customTop: 15,
    customLeft: 38,
  },
];
