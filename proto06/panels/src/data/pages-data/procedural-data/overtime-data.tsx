...
export const ProceduralOVERTIMEPageDescriptions = [
  "P1 - Pending Approver1 | P2 - Pending Approver2 | APD - Approved | DIS - Disapproved",
];


export const ProceduralOVERTIMEPageColumns: GridColDef[] = 
[
  {
    field: 'ot_date_filed',
...
export default {
  ProceduralOVERTIMEPageDescriptions,
  ProceduralOVERTIMEPageColumns
};
